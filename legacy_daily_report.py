...
def get_holidays_this_week() -> dict:
    ...
    for year, month in months_to_query:
        try:
            ...
            print(f"⚠️ 공휴일 API 조회 실패 ({year}/{month}): {e}")
...
def main_gui():
    ...
    start_button.grid(row=1, column=0, columnspan=2, sticky="ew", padx=2, pady=10)
